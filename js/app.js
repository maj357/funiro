...
if (document.querySelector('.slider-main__body')) {
	new Swiper('.slider-main__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-main .slider-arrow_next', // 1ый класс указывать, 2ой тех.
...
if (document.querySelector('.slider-rooms__body')) {
	new Swiper('.slider-rooms__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 'auto', // управление шириной слайда из стилей
		spaceBetween: 24, // отступ между слайдами в px
		speed: 800,
		loop: true,
		watchOverflow: true,
		loopAdditionalSlides: 5,
